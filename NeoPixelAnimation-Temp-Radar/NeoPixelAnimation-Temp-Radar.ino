...
const uint16_t PixelCount = 344; // make sure to set this to the number of pixels in your strip
const uint8_t PixelPin = 3; //21;  // make sure to set this to the correct pin, ignored for Esp8266
